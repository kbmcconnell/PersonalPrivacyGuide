...
If you need another reason, then read this article about how the US government is [partnering with Palantir](https://www.nytimes.com/2025/05/30/technology/trump-palantir-data-americans.html) to build a database on all of us, then read about [Project Esther](https://truthout.org/articles/project-esther-is-a-mccarthy-era-blueprint-for-crushing-the-american-left/).
